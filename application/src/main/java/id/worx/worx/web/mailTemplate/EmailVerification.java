...
public class EmailVerification {
    ...
    public static String EmailVerify(String linkUrl){
        return "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
            ...
            "              <tr>\n" +
            "                <td bgcolor=\"#ffffff\" class=\"header\" style=\"padding: 25px 30px 0 30px\">\n" +
            ...
            "                        </p>\n" +
            "                        <p style=\"margin-top: 18px;\">Thank you for your interest in Worx.</p>\n" +
            "                        <p style=\"margin-top: 18px;\">\n" +
            "                            If you have any problems with your signup, please send a message to\n" +
            "                          <a style=\"color: #DA3630; text-decoration: none;\" href=\"mailto:help@worx.id\">help@worx.id</a>\n" +
            "                        </p>\n" +
            "                        <p style=\"margin-top: 18px;\">\n" +
            "                          Thank you<br />\n" +
            "                          Everyone at Worx\n" +
