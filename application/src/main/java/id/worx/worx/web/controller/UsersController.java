...
public class UsersController {
    ...
    public ResponseEntity<BaseValueResponse<UserResponse>> createUser(
    ...
    public ResponseEntity<String> verifyPasswordResetToken(
            @Valid @RequestBody ChangePasswordToken changePasswordToken) {
        try {
    ...
    public void verifyAccount(@RequestParam String code, HttpServletResponse httpServletResponse)
            throws IOException {
    ...
    public ResponseEntity<BaseResponse> sendMailConfirmation(
    ...
    public ResponseEntity<BaseValueResponse<UserDetailsResponse>> getInfoDevice() {
        ...
        BaseValueResponse<UserDetailsResponse> response =
                BaseValueResponse.<UserDetailsResponse>builder()
                        .value(users)
                        .build();
